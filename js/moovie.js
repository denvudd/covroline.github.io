    ...
    constructor(options) {
        ...
        const defaults = {
            ...
            config : {
                ...
                i18n : {
                    play : "(Играть:Пауза)",
                    mute : "(Без звука:С звуком)",
                    subtitles : "(Включить:Выключить) субтитры",
                    config : "Настройки",
                    fullscreen : "На весь экран",
                    main_topic: "Настройки:",
                    main_caption: "Подсказки",
                    main_offset: "Смещение",
                    main_speed: "Скорость",
                    main_disabled: "Выкл.",
                    main_default: "Обычная",
                    caption_topic: "Подсказки:",
                    caption_back: "Back",
                    caption_load: "Загрузить локально",
                    offset_topic: "Настроить смещение подсказок",
                    speed_topic: "Регулировать скорость"
                }
            },
            icons : {
                path: "./img/icons/"
